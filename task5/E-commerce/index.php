...
$brand = new Brand ;
$brand->setStatus(1);
$brands = $brand->read()->get_result()->fetch_all(MYSQLI_ASSOC);
$products_object = new Product;
 $products = $products_object->getRecentProduct()->get_result()->fetch_all(MYSQLI_ASSOC);
$Ordered_products_object = new Product ;
 $Ordered_products = $Ordered_products_object-> getMost_OrederedProduct()->get_result()->fetch_all(MYSQLI_ASSOC);
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="product-img">
                            <a href="shop.php?brand=<?=$brand_name['id'] ?>">
                                <img alt="" src="assets/img/brand-logo/<?= $brand_name['image']?>">
                            </a>
                        ...
                        <div class="product-content text-left">
							<div class="product-hover-style">
								<div class="product-title">
									<h4>
										<a href="-shop.php?brand=<?=$brand_name['id'] ?>"><?= $brand_name['name_en']?></a>
									</h4>
								</div>
        ...
        <div class="container">
                            ...
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.php">
                                        <img alt="" src="assets/img/product/<?= $Recent_product['image']?>">
                                    </a>
                                    <span>-30%</span>
                                ...
                                <div class="product-content text-left">
                                    <div class="product-hover-style">
                                        <div class="product-title">
                                            <h4>
                                                <a href="product-details.php"><?= $Recent_product['name_en']?></a>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="product-price-wrapper">
                                        <span><?= $Recent_product['price']?>LE</span>
            ...
            <div class="product-top-bar section-border mb-55">
                <div class="section-title-wrap text-center">
                    <h3 class="section-title">Most Ordered Product</h3>
                </div>
            </div>
            <div class="tab-content jump">
                <div class="tab-pane active">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.php">
                                        <img alt="" src="assets/img/product/<?= $Ordered_product['image']?>">
                                    </a>
                                    <span>-30%</span>
                                    <div class="product-action">
                                        <a class="action-wishlist" href="#" title="Wishlist">
                                ...
                                <div class="product-content text-left">
                                    <div class="product-hover-style">
                                        <div class="product-title">
                                            <h4>
                                                <a href="product-details.php"><?=  $Ordered_product['name_en']?></a>
                                            </h4>
                                        </div>
                                        <div class="cart-hover">
                                            <h4><a href="product-details.php">+ Add to cart</a></h4>

...
if($_GET){
    if(isset($_GET['brand'])){
        if(is_numeric($_GET['brand'])){
            ...
            if( $brand-> getbrandby_id()->get_result()->num_rows == 1){
                $product->setBrand_id($_GET['brand']);
                $products = $product->getproductby_brand()->get_result()->fetch_all(MYSQLI_ASSOC);
        ...
        if(is_numeric($_GET['subcategory'])){
            $sub_category->setId($_GET['subcategory']);
            if( $sub_category->getsubcategoryby_id()->get_result()->num_rows == 1){
                $product-> setSubcategory_id($_GET['subcategory']);
                $products = $product->getproductby_subcategory()->get_result()->fetch_all(MYSQLI_ASSOC);
        ...
        if(is_numeric($_GET['category'])){
            ...
            if( $category->getcategoryby_id()->get_result()->num_rows == 1){
                $product-> setCategory_id($_GET['category']);
                $products = $product->getproductby_category()->get_result()->fetch_all(MYSQLI_ASSOC);
...
include "Layouts/error/404.php";
        ...
        $products = $product->read()->get_result()->fetch_all(MYSQLI_ASSOC);
                                    ...
                                    <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <a href="product-details.php?product=<?=$product_name['id']?>">
                                                    <img alt="" src="assets/img/product/<?= $product_name['image']?>">
                                                </a>
                                                <span>-30%</span>
                                            ...
                                            <div class="product-content text-left">
												<div class="product-hover-style">
													<div class="product-title">
														<h4>
															<a href="product-details.php?product=<?=$product_name['id']?>"><?= $product_name['name_en'] ?></a>
														</h4>
													</div>
													<div class="cart-hover">
														<h4><a href="product-details.php?product=<?=$product_name['id']?>">+ Add to cart</a></h4>
													</div>
												</div>
												<div class="product-price-wrapper">
													<span><?= $product_name['price'] ?>LE</span>
												</div>
											</div>

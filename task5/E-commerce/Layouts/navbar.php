        ...
        $categories = $category->read()->get_result()->fetch_all(MYSQLI_ASSOC);
                            ...
                            <div class="header-bottom-right">
                                        ...
                                        <ul>
                                            ...
                                            <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                                <ul class="mega-menu">
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li class="mega-menu-title"><a href="shop.php?category=<?= $category_name['id'] ?>"><?=$category_name['name_en'] ?></a></li>
                                                            <?php 
                                                            
                                                                        $sub_category-> setCategory_id($category_name['id']);
                                                                        $sub_categories = $sub_category->sub_categoryby_category()->get_result()->fetch_all(MYSQLI_ASSOC);
                                                                        foreach($sub_categories as $sub_category_name ){
                                                           
                                                           
                                                           ?>
                                                            <li><a href="shop.php?subcategory=<?= $sub_category_name['id'] ?>"><?= $sub_category_name['name_en'] ?></a></li>
                                                           <?php } ?>
                                                        </ul>
                                                    </li>
                                                   <?php } ?>
								...
								<div class="header-currency">
                                   <?php if(isset($_SESSION['user'])){?>
									<span class="digit"><?php echo $_SESSION['user']->first_name ?? "" ?> <i class="ti-angle-down"></i></span>
                                  ...
                                  <?php   }else{?>
                                        <span class="digit">Welcom <i class="ti-angle-down"></i></span>
                                        <div class="dollar-submenu">
                                            <ul>
